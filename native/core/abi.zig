...
export fn gs_model_dispatch_v1(model: ?*Model, input: Bytes, out_json: ?*Bytes, out_error: ?*Bytes) c_int {
    ...
    }, .maximum = jsonU32(object, "maximum", 0) orelse return fail(invalid_json, "invalid_request", out_error), .attempted = jsonU32(object, "attempted", 0) orelse return fail(invalid_json, "invalid_request", out_error) } } else if (std.mem.eql(u8, kind.string, "connected")) .{ .connected = .{ .revision = jsonU64(object, "revision") orelse return fail(invalid_json, "invalid_request", out_error), .sequence = jsonU64(object, "sequence") orelse return fail(invalid_json, "invalid_request", out_error) } } else if (std.mem.eql(u8, kind.string, "event")) .{ .event = .{ .revision = jsonU64(object, "revision") orelse return fail(invalid_json, "invalid_request", out_error), .sequence = jsonU64(object, "sequence") orelse return fail(invalid_json, "invalid_request", out_error) } } else if (std.mem.eql(u8, kind.string, "refreshed")) .{ .refreshed = .{ .revision = jsonU64(object, "revision") orelse return fail(invalid_json, "invalid_request", out_error), .sequence = jsonU64(object, "sequence") orelse return fail(invalid_json, "invalid_request", out_error) } } else if (std.mem.eql(u8, kind.string, "focus_signal")) .{ .focus_signal = .{ .signal_key = jsonId(object, "signal_key") orelse return fail(invalid_identity, "invalid_request", out_error) } } else if (std.mem.eql(u8, kind.string, "exact_tab_visible")) .{ .exact_tab_visible = .{ .surface_id = jsonId(object, "surface_id") orelse return fail(invalid_identity, "invalid_request", out_error) } } else if (std.mem.eql(u8, kind.string, "remove_signal")) .{ .remove_signal = .{ .signal_key = jsonId(object, "signal_key") orelse return fail(invalid_identity, "invalid_request", out_error) } } else if (std.mem.eql(u8, kind.string, "navigate_pair")) .{ .navigate_pair = .{ .workspace_id = jsonId(object, "workspace_id") orelse return fail(invalid_identity, "invalid_request", out_error), .repository_id = jsonId(object, "repository_id") orelse return fail(invalid_identity, "invalid_request", out_error) } } else return fail(invalid_json, "invalid_request", out_error);
