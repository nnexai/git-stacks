...
pub fn build(b: *std.Build) void {
    ...
    const appearance_config_module = b.createModule(.{ .root_source_file = b.path("linux/appearance_config.zig") });
    const config_test_module = b.createModule(.{ .root_source_file = b.path("tests/appearance_config_test.zig"), .target = b.graph.host, .optimize = .Debug }); config_test_module.addImport("appearance_config", appearance_config_module);
    ...
    app_module.addImport("appearance_config", appearance_config_module);
