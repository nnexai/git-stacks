...
pub const Action=enum{new_shell,launch_command,activate_command,select_tab,next_tab,previous_tab,reorder_tab,rename_tab,rename_current,close_tab,remove_tab,remove_current,relaunch_tab,relaunch_current,focus_attention,open_vscode,pin_workspace,unpin_workspace,reorder_pin};
