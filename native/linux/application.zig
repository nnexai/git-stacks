...
pub const Action=enum{new_workspace,new_shell,launch_command,activate_command,select_tab,next_tab,previous_tab,reorder_tab,rename_tab,rename_current,close_tab,remove_tab,remove_current,relaunch_tab,relaunch_current,focus_attention,open_vscode,pin_workspace,unpin_workspace,reorder_pin};
pub const ActionSpec=struct{name:[]const u8,accelerator:?[]const u8,requires_ready:bool};
pub const actions=[_]ActionSpec{.{.name="win.new-workspace",.accelerator="<Primary><Shift>n",.requires_ready=true},.{.name="win.new-shell",.accelerator="<Primary><Shift>t",.requires_ready=true},.{.name="win.launch-command",.accelerator="<Primary><Shift>p",.requires_ready=true},.{.name="win.activate-command",.accelerator=null,.requires_ready=true},.{.name="win.select-tab",.accelerator=null,.requires_ready=false},.{.name="win.next-tab",.accelerator="<Primary>Page_Down",.requires_ready=false},.{.name="win.previous-tab",.accelerator="<Primary>Page_Up",.requires_ready=false},.{.name="win.reorder-tab",.accelerator=null,.requires_ready=false},.{.name="win.rename-tab",.accelerator=null,.requires_ready=false},.{.name="win.rename-current",.accelerator=null,.requires_ready=false},.{.name="win.close-tab",.accelerator="<Primary><Shift>w",.requires_ready=false},.{.name="win.remove-tab",.accelerator=null,.requires_ready=false},.{.name="win.remove-current",.accelerator=null,.requires_ready=false},.{.name="win.relaunch-tab",.accelerator=null,.requires_ready=true},.{.name="win.relaunch-current",.accelerator=null,.requires_ready=true},.{.name="win.focus-attention",.accelerator=null,.requires_ready=false},.{.name="win.open-vscode",.accelerator=null,.requires_ready=true},.{.name="win.pin-workspace",.accelerator=null,.requires_ready=false},.{.name="win.unpin-workspace",.accelerator=null,.requires_ready=false},.{.name="win.reorder-pin",.accelerator=null,.requires_ready=false}};
