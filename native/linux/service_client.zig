...
pub const Launch = struct {
    ...
    pub fn environmentKey(self: *const Launch, index: usize) []const u8 { return self.environment_keys[index][0..self.environment_key_lens[index]]; }
    pub fn environmentValue(self: *const Launch, index: usize) []const u8 { return self.environment_values[index][0..self.environment_value_lens[index]]; }
    pub fn portKey(self: *const Launch, index: usize) []const u8 { return self.port_keys[index][0..self.port_key_lens[index]]; }
};
