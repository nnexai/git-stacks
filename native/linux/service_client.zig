...
pub const Client = struct {
    ...
    pub fn discoveryRequest(self: *Client) !Request { return self.request(.GET, "/v1/discovery", ""); }
    pub fn snapshotRequest(self: *Client, workspace_id: []const u8) !Request {
        ...
        // Paths are consumed synchronously by the transport.
    ...
    pub fn launchRequestAlloc(self: *Client, allocator: std.mem.Allocator, workspace_id: []const u8, repository_id: []const u8, command_id: ?[]const u8) !Request {
        ...
        return self.request(.POST, "/v1/native/launch-resolution", body);
    }
