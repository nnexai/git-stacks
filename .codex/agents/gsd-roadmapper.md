...
Reference full template: `/home/nnex/dev/prj/git-stacks/.codex/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/home/nnex/dev/prj/git-stacks/.codex/get-shit-done/templates/state.md`.
