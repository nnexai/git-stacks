...
Reference full template: `/home/nnex/dev/prj/git-stacks/.codex/gsd-core/templates/roadmap.md`

## STATE.md Structure

Use template from `/home/nnex/dev/prj/git-stacks/.codex/gsd-core/templates/state.md`.
