...
@/home/nnex/dev/prj/git-stacks/.codex/get-shit-done/references/thinking-models-execution.md
...
**See @/home/nnex/dev/prj/git-stacks/.codex/get-shit-done/references/checkpoints.md**
...
```bash
node /home/nnex/dev/prj/git-stacks/.codex/get-shit-done/bin/gsd-tools.cjs commit-to-subrepo "{type}({phase}-{plan}): {concise task description}" --files file1 file2 ...
```
...
**Use template:** @/home/nnex/dev/prj/git-stacks/.codex/get-shit-done/templates/summary.md
...
node "/home/nnex/dev/prj/git-stacks/.codex/get-shit-done/bin/gsd-tools.cjs" roadmap update-plan-progress "${PHASE_NUMBER}"
...
```bash
node "/home/nnex/dev/prj/git-stacks/.codex/get-shit-done/bin/gsd-tools.cjs" state add-blocker "Blocker description"
```
</state_updates>
