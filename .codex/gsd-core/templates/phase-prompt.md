...
<!-- For checkpoint task examples and patterns, see @/home/nnex/dev/prj/git-stacks/.codex/gsd-core/references/checkpoints.md -->
...
See `/home/nnex/dev/prj/git-stacks/.codex/gsd-core/references/tdd.md` for TDD plan structure.
...
See `/home/nnex/dev/prj/git-stacks/.codex/gsd-core/templates/user-setup.md` for full schema and examples
...
See `/home/nnex/dev/prj/git-stacks/.codex/gsd-core/workflows/verify-phase.md` for verification logic.
