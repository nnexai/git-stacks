...
```markdown
Read /home/nnex/dev/prj/git-stacks/.codex/agents/gsd-ui-researcher.md for instructions.
...
Template: /home/nnex/dev/prj/git-stacks/.codex/gsd-core/templates/UI-SPEC.md
</output>
...
```markdown
Read /home/nnex/dev/prj/git-stacks/.codex/agents/gsd-ui-checker.md for instructions.
...
@/home/nnex/dev/prj/git-stacks/.codex/gsd-core/references/ui-consideration-probe.md.
...
# (#448) — NOT the consuming project's git root — falling back to git toplevel / /home/nnex/dev/prj/git-stacks/.codex.
...
UI_PROBE_JS=$(for _c in \
  ...
  "/home/nnex/dev/prj/git-stacks/.codex/gsd-core/bin/lib/ui-consideration-probe.cjs" \
  "/home/nnex/dev/prj/git-stacks/.codex/bin/lib/ui-consideration-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
