...
```
Agent(
  prompt="Read /home/nnex/dev/prj/git-stacks/.codex/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/nnex/dev/prj/git-stacks/.codex/gsd-core/templates/VALIDATION.md`
