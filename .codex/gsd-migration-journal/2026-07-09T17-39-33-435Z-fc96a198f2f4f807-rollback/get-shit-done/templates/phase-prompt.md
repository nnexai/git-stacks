...
<!-- For checkpoint task examples and patterns, see @/home/nnex/dev/prj/git-stacks/.codex/get-shit-done/references/checkpoints.md -->
...
See `/home/nnex/dev/prj/git-stacks/.codex/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `/home/nnex/dev/prj/git-stacks/.codex/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `/home/nnex/dev/prj/git-stacks/.codex/get-shit-done/workflows/verify-phase.md` for verification logic.
