...
<required_reading>
@/home/nnex/dev/prj/git-stacks/.codex/get-shit-done/references/ai-frameworks.md
@/home/nnex/dev/prj/git-stacks/.codex/get-shit-done/references/ai-evals.md
</required_reading>
...
Copy template:
```bash
cp "/home/nnex/dev/prj/git-stacks/.codex/get-shit-done/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
