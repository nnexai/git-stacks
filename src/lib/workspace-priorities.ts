import { listWorkspacesUncached, writeWorkspace, type Workspace } from "./config"
...
export function setWorkspacePriorities(
  ...
  dependencies: WorkspacePriorityDependencies = { listWorkspaces: listWorkspacesUncached, writeWorkspace },
): void {
