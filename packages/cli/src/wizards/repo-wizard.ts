import { prompts as p, cancel } from "../prompts"

import { readRegistry, writeRegistry } from "@git-stacks/core/config"
import { scanForRepos } from "@git-stacks/core/detect"
import { getCurrentBranch } from "@git-stacks/core/git"
import { detectForgeForRepo } from "@git-stacks/core/integrations/forge-utils"
