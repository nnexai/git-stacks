...
const RC_VERSION = "0.22.0-rc.3"
const RC_TAG = "v0.22.0-rc.3"
...
describe("v0.22.0 release candidate metadata", () => {
  ...
  test("current RC changelog and stale guide describe the exact advisory product boundary", () => {
    ...
    expect(CHANGELOG).toContain("## [0.22.0-rc.3] - 2026-07-18")
    expect(rcEntry).toContain("0.22.0-rc.3 / v0.22.0-rc.3; npm prerelease publication uses next")
