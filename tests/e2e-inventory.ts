...
export const E2E_INVENTORY: readonly E2EInventoryItem[] = [
  ...
  },
  {
    ...
    rationale: "Path helpers depend on explicit cwd/path handling and now have both happy-path and representative missing-path coverage.",
  },
  {
    id: "workspace.env",
    family: "workspace",
    ...
    rationale: "Environment rendering is covered by baseline subprocess tests plus 82.1 support-command and missing-secret coverage.",
  },
  {
