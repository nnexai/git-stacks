...
export const E2E_INVENTORY: readonly E2EInventoryItem[] = [
  ...
  },
  {
    ...
    commands: [
      "service start", "service stop", "service status", "service signal publish",
      "service expose enable", "service expose disable", "service expose status",
      "service pair create", "service pair accept", "service pair list", "service pair revoke",
      "service targets list", "service targets remove",
    ],
    scopeStatus: "in-scope",
    mappedTests: [
      "tests/service/operations.test.ts",
      "tests/service-node/secure-runtime.test.mjs",
      "tests/service-node/secure-remote-runtime.test.mjs",
      "tests/service-node/secure-trust-store.test.mjs",
  ...
  },
  {
    ...
    scopeStatus: "in-scope",
    mappedTests: ["tests/commands/hooks.test.ts", "tests/lib/agent-hooks.test.ts", "tests/lib/agent-hooks/integration-manager.test.ts"],
  ...
  },
  {
    ...
    mappedTests: [
      ...
      "tests/service-node/secure-runtime.test.mjs",
      "tests/service-node/secure-terminal-runtime.test.mjs",
  ...
  },
  {
    ...
    mappedTests: [
      ...
      "tests/commands/support-doctor.test.ts",
    ],
  ...
  },
  {
    ...
    commands: ["completion", "env", "paths", "doctor", "hooks", "integration", "config", "repo"],
    scopeStatus: "excluded",
    mappedTests: [],
