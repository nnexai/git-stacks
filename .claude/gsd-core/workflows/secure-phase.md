...
```
Agent(
  prompt="Read /home/nnex/dev/prj/git-stacks/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/nnex/dev/prj/git-stacks/.claude/gsd-core/templates/SECURITY.md`
