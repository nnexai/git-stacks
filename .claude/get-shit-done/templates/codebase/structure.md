...
- Usage: Reference from command with `@/home/nnex/workspaces/tasks/cleanup/git-stacks/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /home/nnex/workspaces/tasks/cleanup/git-stacks/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /home/nnex/workspaces/tasks/cleanup/git-stacks/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
