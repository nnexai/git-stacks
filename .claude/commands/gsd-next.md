...
<execution_context>
@/home/nnex/dev/prj/git-stacks/.claude/gsd-core/workflows/smart-entry.md
...
<process>
Follow /home/nnex/dev/prj/git-stacks/.claude/gsd-core/workflows/smart-entry.md. Detect the situation, present the menu, and dispatch exactly one command. Then stop.
</process>
