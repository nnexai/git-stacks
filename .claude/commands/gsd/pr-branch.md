...
<execution_context>
@/home/nnex/dev/prj/git-stacks/.claude/get-shit-done/workflows/pr-branch.md
</execution_context>

<process>
Execute the pr-branch workflow from @/home/nnex/dev/prj/git-stacks/.claude/get-shit-done/workflows/pr-branch.md end-to-end.
</process>
