...
<execution_context>
@/home/nnex/dev/prj/git-stacks/.claude/get-shit-done/workflows/docs-update.md
</execution_context>
...
<process>
Execute the docs-update workflow from @/home/nnex/dev/prj/git-stacks/.claude/get-shit-done/workflows/docs-update.md end-to-end.
