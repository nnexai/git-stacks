...
Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /home/nnex/dev/prj/git-stacks/.claude/get-shit-done
                  → writes to /home/nnex/dev/prj/git-stacks/.claude/get-shit-done/hooks/
...
@/home/nnex/dev/prj/git-stacks/.claude/get-shit-done/references/thinking-models-debug.md
...
- Read @/home/nnex/dev/prj/git-stacks/.claude/get-shit-done/references/common-bug-patterns.md
...
```bash
node "/home/nnex/dev/prj/git-stacks/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "/home/nnex/dev/prj/git-stacks/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
