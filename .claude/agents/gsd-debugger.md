...
<required_reading>
@/home/nnex/dev/prj/git-stacks/.claude/gsd-core/references/common-bug-patterns.md
</required_reading>
...
@/home/nnex/dev/prj/git-stacks/.claude/gsd-core/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /home/nnex/dev/prj/git-stacks/.claude
                  → checks /home/nnex/dev/prj/git-stacks/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /home/nnex/dev/prj/git-stacks/.claude/gsd-core
                  → writes to /home/nnex/dev/prj/git-stacks/.claude/gsd-core/hooks/
...
@/home/nnex/dev/prj/git-stacks/.claude/gsd-core/references/thinking-models-debug.md
...
- Read @/home/nnex/dev/prj/git-stacks/.claude/gsd-core/references/common-bug-patterns.md
