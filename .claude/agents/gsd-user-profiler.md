...
<reference>
@/home/nnex/dev/prj/git-stacks/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `/home/nnex/dev/prj/git-stacks/.claude/get-shit-done/references/user-profiling.md` to load:
