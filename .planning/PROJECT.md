...
**Target features:**
- **Dashboard overhaul** — Tabbed layout (Workspaces | Templates | Repos), list + detail pane per tab, all CLI actions accessible in-TUI, system editor integration for config files *(Phase 8 complete — 2026-03-20)*
...
---
*Last updated: 2026-03-20 — Phase 8 complete (dashboard tab layout)*
