...
- [x] 107-03 — Expose authenticated catalog and idempotent capacity-safe workspace creation
...
- [x] 107-07 — Preserve provider-aware attention and enforce truthful native capacity behavior

Wave 5 *(blocked on durable service and shared native contracts)*:

- [x] 107-08 — Decode creation/invalidation/gap contracts and build the GTK-free creation controller

Wave 6 *(blocked on native protocol/controller)*:

- [x] 107-09 — Reconcile authoritative snapshots, retain live orphans, and coalesce refresh/cursor recovery

Wave 7 *(blocked on reconciliation and refresh coordination)*:

- [x] 107-10 — Compose empty-start workspace creation and worker-owned synchronization in GTK
...
- [x] 107.2-03-PLAN.md — Bind final 107.1 provider sessions and signals to workspace presence and the grouped inbox
...
| 107. Native workspace UI beautification and UX finalization | 12/13 | In Progress|  |
