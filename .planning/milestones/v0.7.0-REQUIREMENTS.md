# Requirements Archive: v0.7.0 Close Command & Polish
...
- [x] **MOCK-05**: Test files mock `@/tui/utils` (not `@clack/prompts`) — dead mocks eliminated, fragile ordering dependencies removed
...
- [x] **LC-08**: `closeWorkspace` fires `post_close` hooks after integration cleanup and injects `GS_TRIGGERED_BY` env var (per D-04)
...
| ISSUE-01 | Phase 28 | Complete |
| ISSUE-02 | Phase 28 | Complete |
| ISSUE-03 | Phase 28 | Complete |
| ISSUE-04 | Phase 28 | Complete |
| ISSUE-05 | Phase 28 | Complete |
| ISSUE-06 | Phase 28 | Complete |
| ISSUE-07 | Phase 28 | Complete |
| ISSUE-08 | Phase 28 | Complete |
| ISSUE-09 | Phase 28 | Complete |
| ISSUE-10 | Phase 28 | Complete |

**Coverage:**
- v0.7.0 requirements: 58 total
- Mapped to phases: 58
- Unmapped: 0

---
*Requirements defined: 2026-03-22*
*Last updated: 2026-03-22 after v0.7.0 milestone audit*
