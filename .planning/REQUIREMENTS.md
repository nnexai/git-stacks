...
- [ ] **AB-01**: User can see per-repo commit distance from base branch via `getCommitsAhead` primitive
...
- [ ] **AB-07**: Staleness detection via FETCH_HEAD mtime with 15-minute threshold and `aheadBehindStale` flag
