...
- [x] **BUG-02**: Branch names containing '/' are handled correctly for GitLab `open` and `pr` commands
...
- [x] **WUX-03**: Auto-detection extends to all tracker integrations (GitHub, GitLab, Gitea issue commands)
...
| BUG-02 | Phase 32 | Complete |
| WUX-01 | Phase 29 | Complete |
| WUX-02 | Phase 31 | Complete |
| WUX-03 | Phase 31 | Complete |
